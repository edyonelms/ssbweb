...
<div class="sticky top-0 z-20 bg-white border-b border-slate-200">
    ...
    <div class="px-6 lg:px-10 py-2.5 flex flex-wrap items-center gap-x-4 gap-y-2 text-xs">
        ...
        <form method="GET" action="{{ route('enquiries.index') }}" class="ml-auto flex items-center gap-1.5">
            ...
            <div class="relative">
                ...
                <input type="text" name="q" value="{{ $search }}" placeholder="Search name, email…"
                ...
                <li class="enquiry-row hover:bg-slate-50 transition cursor-pointer px-6 py-4" data-enquiry-id="{{ $e->id }}">
                    <div class="flex items-start gap-3">
                        ...
                        <div class="flex items-center gap-1 shrink-0" onclick="event.stopPropagation()">
                            <button type="button" onclick="EnquiryPanel.openView({{ $e->id }})"
                                    title="View"
                            ...
                            <form method="POST" action="{{ route('enquiries.destroy', $e) }}"
