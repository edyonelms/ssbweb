...
<head>
    ...
    {{-- Match the rest of the app — the splash should feel like an app
         launch screen on phones (notch handling, OS chrome painted pink). --}}
    ...
    <style>
        body { font-family: 'Inter', sans-serif; margin: 0; padding: 0; -webkit-tap-highlight-color: transparent; }
